...
**「`sold_out`に終了済みAuctionは現れない」ことの証明ではない。** 対象の10 Sellerに
無かっただけの可能性がある。標本が得られるまで`assumed` Fixtureは作らない。

実測は[ライブ受入検証結果 §12.6](../../../../docs/phase-0/phase-0-f-live-acceptance-result.md#126-終了済みauction合格基準外の観測)。

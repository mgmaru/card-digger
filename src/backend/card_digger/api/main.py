...
def _profile_failure(analysis: SellerAnalysis) -> HTTPException:
    ...
    if error is None:
        ...
        return HTTPException(status_code=503, detail={"code": "safety_stop"})
...
def create_app(
    *,
    ...
    async def seller_analysis(seller_id: str) -> SellerAnalysisResponse:
        ...
        if analysis.seller is None:
            raise _profile_failure(analysis)

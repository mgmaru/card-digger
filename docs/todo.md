...
|---|---:|---:|---:|
| 商品検索 | 5 / 5成功 | 未検証 | 未検証 |
| 出品日時 | 100 / 100 | 未検証 | 未検証 |
| 販売状態 | 100 / 100 | 未検証 | 未検証 |
| 古い商品へのページング | 5ページ・589件で365日超へ到達。ただし古い順は失敗 | 未検証 | 未検証 |
| 画像URL | 100 / 100 | 未検証 | 未検証 |
| 画像本体のHTTP取得・デコード | 20 / 20 | 未検証 | 未検証 |
| 商品コンディション | 0 / 20（詳細解析失敗） | 未検証 | 未検証 |
| いいね数 | 0 / 20（詳細解析失敗） | 未検証 | 未検証 |
| Seller ID | 0 / 100 | 未検証 | 未検証 |
| Seller Profile | 非対応 | 未検証 | 未検証 |
| Sellerの販売中商品一覧 | 非対応 | 未検証 | 未検証 |
| Sellerの売却済み商品一覧 | 非対応 | 未検証 | 未検証 |
| 実装難易度 | 高 | 未検証 | 未検証 |
| 実行速度 | 検索中央値197.07ms、全体101.6秒 | 未検証 | 未検証 |
| 安定性 | 検索100%、詳細0% | 未検証 | 未検証 |
| 保守性 | 低め | 比較的高い | 自前保守 |
| 総合評価 | 早期撤退 | - | - |

...
- [ ] 十分古い販売中商品まで遡れるか確認する
- [ ] Seller IDを取得可能か確認する
- [ ] Seller Profileを取得できるか確認する
- [ ] Sellerの販売中商品一覧を取得できるか確認する
- [ ] Sellerの売却済み商品一覧を取得できるか確認する
...
| 画像URL | 未検証 | 未検証 | 未検証 |
| 画像本体のHTTP取得・デコード | 未検証 | 未検証 | 未検証 |
| 商品コンディション | 未検証 | 未検証 | 未検証 |
| いいね数 | 未検証 | 未検証 | 未検証 |
| Seller ID | 未検証 | 未検証 | 未検証 |
| Seller Profile | 未検証 | 未検証 | 未検証 |
| Sellerの販売中商品一覧 | 未検証 | 未検証 | 未検証 |
| Sellerの売却済み商品一覧 | 未検証 | 未検証 | 未検証 |
| 実装難易度 | 未検証 | 未検証 | 未検証 |
| 実行速度 | 未検証 | 未検証 | 未検証 |
| 安定性 | 未検証 | 未検証 | 未検証 |
| 保守性 | 低め | 比較的高い | 自前保守 |

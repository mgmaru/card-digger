...
**採らなかった案は[O-8](#o-8--sellerの活動で絞るのを今やらない理由2026-09-04)と
...
| Sellerの活動 | **その人**が最後に動いた時刻 | **検索結果には無い。** Seller画面では取得できた範囲について[既に出している](../product/mvp-spec.md#最も新しい更新を出す2026-09-03決定)（[O-8](#o-8--sellerの活動で絞るのを今やらない理由2026-09-04)） |
...
- [ ] O-8 Sellerの活動で検索結果を絞る（**下記のとおり判断済み**）
- [ ] O-9 状態をMercariへ送って母集団を絞る（**表示を先に入れる。下記のとおり判断済み**）

### O-8 — Sellerの活動で絞るのを今やらない理由（2026-09-04）
...
- Seller画面の「最も新しい更新」で1人ずつ確かめるだけでは足りなくなったとき
- Seller収集の費用が下がったとき

...
> **測るまで着手しない。**そのうち1件（見送った理由を20〜30件記録する）は**利用者にしかできない。**
>
...
## 着手前に決めること — **未決。まず測る（2026-09-05に整理した）**

**何も決めていない。決めるための材料が無い。**
下の実装項目に手を付ける前に、[測る2件](#決める前に測る2件)を先に置く。
...
[9] 使う（現在）
     ├─ 追加したくなったものを実装する
     └─ 見送った理由を記録する → Phase 2の材料になる
        ↓
[10] Phase 2の4件を決める（測ってから）
```
...
**[10]へ進む条件は「測ったこと」である。**
[Phase 2の着手前に決めること](#着手前に決めること--未決まず測る2026-09-05に整理した)を参照する。
